ASSERTSFOLDER=assets/timeline
for mediaFile in `ls $ASSERTSFOLDER | grep .mp4`; do 
    # echo $mediaFile
    ...
    INPUT=$ASSERTSFOLDER/$mediaFile
    FOLDER_TARGET=$ASSERTSFOLDER/$FILENAME
    mkdir -p $FOLDER_TARGET

    # criar arquivos de resoluçoes diferentes na pasta

    OUTPUT=$ASSERTSFOLDER/$FILENAME/$FILENAME 
